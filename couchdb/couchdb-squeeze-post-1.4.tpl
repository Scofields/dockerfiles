...
RUN apt-get update
RUN apt-get install -y --force-yes erlang build-essential libtool autoconf automake autoconf-archive pkg-config libssl0.9.8 libssl-dev zlib1g zlib1g-dev libcurl4-openssl-dev lsb-base ncurses-dev libncurses-dev libmozjs-dev libmozjs2d libicu-dev xsltproc make wget python-simplejson
ADD http://www.eu.apache.org/dist/couchdb/source/${couchdb}/apache-couchdb-${couchdb}.tar.gz /tmp/apache-couchdb-${couchdb}.tar.gz
