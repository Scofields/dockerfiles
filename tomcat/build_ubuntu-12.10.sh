...
docker build --rm -t rstiller/tomcat:ubuntu-12.10_oracle-jdk-1.7_tomcat-7.0.52 - < ubuntu-12.10_oracle-jdk-1.7_tomcat-7.0.52 && \
...
#docker build --rm -t rstiller/tomcat:ubuntu-12.10_openjdk-jdk-1.7_tomcat-7.0.52 - < ubuntu-12.10_openjdk-jdk-1.7_tomcat-7.0.52 && \
...
docker build --rm -t rstiller/tomcat:ubuntu-12.10_openjdk-jdk-1.6_tomcat-7.0.52 - < ubuntu-12.10_openjdk-jdk-1.6_tomcat-7.0.52 && \
docker build --rm -t rstiller/tomcat:ubuntu-12.10_openjdk-jdk-1.6_tomcat-latest - < ubuntu-12.10_openjdk-jdk-1.6_tomcat-7.0.52
