...
docker build --rm -t rstiller/tomcat:debian-7.1_oracle-jdk-1.7_tomcat-7.0.52 - < debian-7.1_oracle-jdk-1.7_tomcat-7.0.52 && \
...
docker build --rm -t rstiller/tomcat:debian-7.1_openjdk-jdk-1.7_tomcat-7.0.52 - < debian-7.1_openjdk-jdk-1.7_tomcat-7.0.52 && \
...
docker build --rm -t rstiller/tomcat:debian-7.1_openjdk-jdk-1.6_tomcat-7.0.52 - < debian-7.1_openjdk-jdk-1.6_tomcat-7.0.52 && \
docker build --rm -t rstiller/tomcat:debian-7.1_openjdk-jdk-1.6_tomcat-latest - < debian-7.1_openjdk-jdk-1.6_tomcat-7.0.52
